...
import org.java.collections.collection.list.CustomArrayList;
...
class CustomArrayListTest {
    ...
    private List<Integer> arrayList = new CustomArrayList<>();
    ...
    void createListWithSpecificArrayCapacity() {
        arrayList = new CustomArrayList<>(8);
    ...
    void createListWithWrongCapacity() {
        assertThatExceptionOfType(IllegalArgumentException.class)
                .isThrownBy(() -> arrayList = new CustomArrayList<>(-2));
    }

    @Test
    @Order(11)
    void addElements() {
        arrayList = CustomArrayList.of(15, 69, 58, 78);
    ...
    void addShouldResizeSpecificCapacityWhenArrayIsFull() {
        arrayList = new CustomArrayList<>(4);
    ...
    void containsNotExistingWhenArrayIsNotFilled() {
        arrayList = new CustomArrayList<>(100);
        Object[] internalArray = getTestArray();
        internalArray[0] = 5;
        internalArray[1] = 10;

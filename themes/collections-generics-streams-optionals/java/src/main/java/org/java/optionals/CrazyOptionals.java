...
import org.java.streams.ExerciseNotCompletedException;
...
public class CrazyOptionals {
    ...
    /**
     * Returns account provided by {@link AccountProvider}. If no account is provided it generates one using {@link Account}
     ...
     */
    public static Account getAccount(AccountProvider accountProvider) throws AccountNotFoundException {
    ...
    /**
     * Returns an {@link Account} with the highest balance. Throws {@link java.util.NoSuchElementException} if input
     * list is empty
     *
     * @param accounts
